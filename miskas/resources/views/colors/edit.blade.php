                    ...
                    <form method="post" action="{{route('colors-update', $color)}}">
                        <div class="mb-3">
                            ...
                            <input type="color" name="color" class="form-control form-control-color"
                                id="exampleColorInput" title="Choose your color" value="{{$color->color}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Author</label>
                            <input name="color_author" type="text" class="form-control" value="{{$color->author}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Rate</label>
                            <input name="color_rate" type="number" class="form-control" value={{$color->rate}}>
                        </div>
